...
typedef enum EGSyst {
  ...
  kXSecTwkDial_ZExpCCQE,          ///< tweak Z-expansion coefficients, affects dsigma(CCQE)/dQ2 both in shape and normalization
...
public:
 ...
 static string AsString(GSyst_t syst) 
 {
   switch(syst) {
     ...
     case ( kXSecTwkDial_ZExpCCQE         ) : return "ZExpCCQE";             break;
